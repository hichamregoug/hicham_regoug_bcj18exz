package com.school.managementapi.security;
...
import static com.school.managementapi.constant.SecurityConstant.*;
...
public class JWTTokenProvider {
    ...
    public String generateJwtToken(UserPrincipal userPrincipal) {
        ...
        return JWT.create().withIssuer(GET_ISSUER).withAudience(GET_AUDIENCE)
                ...
                .withExpiresAt(new Date(System.currentTimeMillis() + TOKEN_ROTATION))
    ...
    private JWTVerifier getJWTVerifier() {
        ...
        try {
            ...
            throw new JWTVerificationException(TOKEN_VERIFICATION_MESSAGE);
        }
        return verifier;
    }
